...
**Plans:** 4 plans
Plans:
- [ ] 09-01-PLAN.md — Wave 1: WorkDescription model fields, DRF_SCHEMA_DDL, test stubs + drf_db fixture
- [ ] 09-02-PLAN.md — Wave 2: scripts/ingest_drf.py + app/services/drf_service.py (keyword matching + confirmation)
...
| 9. DND DRF Integration | 0/4 | Not started | - |
